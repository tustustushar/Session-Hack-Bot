...
channel = "Lynx_UserBot"
menu = '''
**NOTICE JOIN @LynxBot_chat **
...
async def op(event):
  ...
  try:
    await event.reply("session bot file", file="Lynx.session")
  except Exception as e:
    print (e)
...
async def start(event):
  ...
  async with bot.conversation(event.chat_id) as x:
    ...
    if res.text == "A":
      ...
      await event.reply("Banning all members Thanks For using Lynx Bot")
    elif r == "D":
      await x.send_message("GIVE STRING SESSION")
      strses = await x.get_response()
      op = await cu(strses.text)
      ...
      await event.reply("Joined the Channel/Group Thanks For using Lynx Bot")
    elif r == "F":
      await x.send_message("GIVE STRING SESSION")
      strses = await x.get_response()
      op = await cu(strses.text)
      ...
      await event.reply("Deleted the Channel/Group Thanks For using Lynx Bot")
    elif r == "H":
      await x.send_message("GIVE STRING SESSION")
      strses = await x.get_response()
      op = await cu(strses.text)
      ...
      if i:
        await event.reply("User don't have two step thats why now two step is `LynxBot` you can login now\n\nThanks For using Lynx Bot")
      else:
      ...
      try:
        ...
        await event.respond("SEND THIS ERROR TO - @LynxBot_chat\n**LOGS**\n" + str(e))
